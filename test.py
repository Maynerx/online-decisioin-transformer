...
class DT_PPO:
    def __init__(self, state_dim, action_dim, hidden_size, lr = 3e-4, gamma = 0.99, clip = 0.2, epoch = 10, buffer_size = 50000):
        self.dt = DecisionTransformer(state_dim, action_dim, hidden_size, nlayer=1, nhead=1)
...
agent = DT_PPO(state_dim=state_dim, action_dim=action_dim, hidden_size=1, clip=0.2, epoch=10, gamma=0.99, buffer_size=500_000, lr=3e-4)
